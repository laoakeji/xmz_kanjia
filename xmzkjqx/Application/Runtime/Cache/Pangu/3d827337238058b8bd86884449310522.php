...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-system">
			<dt><i class="Hui-iconfont">&#xe627;</i> 界面设计<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="<?php echo U('Index/llist');?>" href="javascript:void(0)">砍价单品</a></li>
		...
		<dl id="menu-system">
			<dt><i class="Hui-iconfont">&#xe627;</i> 砍价设置<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="<?php echo U('Index/kanjia');?>" href="javascript:void(0)">砍价参数设置</a></li>
					<!-- <li><a _href="<?php echo U('Index/prize');?>?type=2" href="javascript:void(0)">套餐</a></li> -->
				</ul>
			</dd>
		</dl>
		<dl id="menu-system">
			<dt><i class="Hui-iconfont">&#xe627;</i> 活动进度<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="<?php echo U('Index/kj_result');?>" href="javascript:void(0)">砍价活动</a></li>
					<li><a _href="<?php echo U('Index/dk_result');?>" href="javascript:void(0)">骑行活动</a></li>
				</ul>
			</dd>
		</dl>
	</div>
